...
def enviar_correo_adjuntos(destinatarios, titulo):
    ...
    #print(getcwd())
    ruta=getcwd()
    ruta_definitiva=path.join(ruta,'utils','Imagen.jpg')
    with open(ruta_definitiva,'rb') as archivo:
        archivo= MIMEApplication(archivo.read(), Name='Imagen.jpg')
        #print(archivo)

    archivo['Content-Disposition']= 'attachment; filename="Imagen.jpg"'
